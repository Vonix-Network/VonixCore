...
// import network.vonix.vonixcore.auth.AuthConfig; // TODO: Create AuthConfig class
...
public class LuckPermsIntegration {
    ...
    public static boolean initialize() {
        // TODO: Uncomment when AuthConfig is created
    ...
    public static CompletableFuture<Void> synchronizeRank(UUID uuid, VonixNetworkAPI.LoginResponse.User user) {
        ...
        return CompletableFuture.runAsync(() -> {
            try {
                ...
                // Default protected ranks for now
                Set<String> protectedRanks = Set.of("admin", "owner", "moderator");

...
public class ClaimsManager {
    ...
    public void initializeTable(Connection conn) throws SQLException {
        // Claims table
        // Auto-increment syntax needs to be handled if we want to be safe, but adhering
        // to logic seen in DatabaseConfig/Database it depends on DB type.
        // For now, assuming basic SQLite/generic support as per existing pattern or
        // minimal effort like Fabric version.
        // Fabric version used "AUTOINCREMENT" which is SQLite specific. We reuse it
        // here.

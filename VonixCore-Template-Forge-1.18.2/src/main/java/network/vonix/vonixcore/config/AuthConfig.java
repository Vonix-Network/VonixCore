 ...
 * Stored in config/vonixcore-auth.toml
 */
public class AuthConfig {
    ...
    private AuthConfig(ForgeConfigSpec.Builder builder) {
        // No-op: all fields are static and initialized in the static block
    }
}

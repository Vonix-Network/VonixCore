...
public class AuthConfig {
    ...
    public static final ModConfigSpec.BooleanValue ENABLE_LUCKPERMS_SYNC;
    public static final ModConfigSpec.ConfigValue<String> ADMIN_RANK_IDS;

    public static final ModConfigSpec.BooleanValue REQUIRE_AUTHENTICATION;
    public static final ModConfigSpec.BooleanValue FREEZE_UNAUTHENTICATED;
    public static final ModConfigSpec.BooleanValue WARN_OF_AUTH;
    public static final ModConfigSpec.IntValue LOGIN_TIMEOUT;

    public static final ModConfigSpec.ConfigValue<String> API_BASE_URL;
    public static final ModConfigSpec.ConfigValue<String> REGISTRATION_API_KEY;
    public static final ModConfigSpec.IntValue API_TIMEOUT;
    public static final ModConfigSpec.ConfigValue<String> REGISTRATION_URL;

    public static final ModConfigSpec.ConfigValue<String> LOGIN_REQUIRED_MESSAGE;
    public static final ModConfigSpec.ConfigValue<String> AUTH_WARNING_MESSAGE;
    public static final ModConfigSpec.ConfigValue<String> GENERATING_CODE_MESSAGE;
    public static final ModConfigSpec.ConfigValue<String> REGISTRATION_CODE_MESSAGE;
    public static final ModConfigSpec.ConfigValue<String> ALREADY_AUTHENTICATED_MESSAGE;
    public static final ModConfigSpec.ConfigValue<String> AUTHENTICATING_MESSAGE;
    public static final ModConfigSpec.ConfigValue<String> AUTHENTICATION_SUCCESS_MESSAGE;
    public static final ModConfigSpec.ConfigValue<String> LOGIN_FAILED_MESSAGE;

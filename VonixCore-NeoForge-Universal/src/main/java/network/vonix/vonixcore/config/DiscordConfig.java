...
public class DiscordConfig {
    ...
    public final ModConfigSpec.ConfigValue<String> webhookId;
    public final ModConfigSpec.ConfigValue<String> inviteUrl;

    // Server identity
    public final ModConfigSpec.ConfigValue<String> serverPrefix;
    public final ModConfigSpec.ConfigValue<String> serverName;
    public final ModConfigSpec.ConfigValue<String> serverAvatarUrl;

    // Message formats
    public final ModConfigSpec.ConfigValue<String> discordToMinecraftFormat;
    public final ModConfigSpec.ConfigValue<String> minecraftToDiscordFormat;
    public final ModConfigSpec.ConfigValue<String> webhookUsernameFormat;
    public final ModConfigSpec.ConfigValue<String> avatarUrl;

    // Event settings
    public final ModConfigSpec.BooleanValue sendJoin;
    public final ModConfigSpec.BooleanValue sendLeave;
    public final ModConfigSpec.BooleanValue sendDeath;
    public final ModConfigSpec.BooleanValue sendAdvancement;
    public final ModConfigSpec.ConfigValue<String> eventChannelId;
    public final ModConfigSpec.ConfigValue<String> eventWebhookUrl;

    // Loop prevention
    public final ModConfigSpec.BooleanValue ignoreBots;
    public final ModConfigSpec.BooleanValue ignoreWebhooks;
    public final ModConfigSpec.BooleanValue filterByPrefix;
    public final ModConfigSpec.BooleanValue showOtherServerEvents;

    // Bot status
    public final ModConfigSpec.BooleanValue setBotStatus;
    public final ModConfigSpec.ConfigValue<String> botStatusFormat;

    // Account linking
    public final ModConfigSpec.BooleanValue enableAccountLinking;
    public final ModConfigSpec.IntValue linkCodeExpiry;

    // Advanced
    public final ModConfigSpec.BooleanValue debugLogging;
    public final ModConfigSpec.IntValue messageQueueSize;
    public final ModConfigSpec.IntValue rateLimitDelay;

    static {
        Pair<DiscordConfig, ModConfigSpec> pair = new ModConfigSpec.Builder()
                .configure(DiscordConfig::new);
        CONFIG = pair.getLeft();
        SPEC = pair.getRight();
    }

    private DiscordConfig(ModConfigSpec.Builder builder) {
        builder.comment(

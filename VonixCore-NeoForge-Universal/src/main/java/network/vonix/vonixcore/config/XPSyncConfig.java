...
public class XPSyncConfig {
    ...
    // API settings
    public final ModConfigSpec.ConfigValue<String> apiEndpoint;
    ...
    // Data options
    public final ModConfigSpec.BooleanValue trackPlaytime;
    public final ModConfigSpec.BooleanValue trackHealth;
    public final ModConfigSpec.BooleanValue trackHunger;
    public final ModConfigSpec.BooleanValue trackPosition;

    // Advanced
    public final ModConfigSpec.BooleanValue verboseLogging;
    public final ModConfigSpec.IntValue connectionTimeout;
    public final ModConfigSpec.IntValue maxRetries;

    static {
        Pair<XPSyncConfig, ModConfigSpec> pair = new ModConfigSpec.Builder()
                .configure(XPSyncConfig::new);
        CONFIG = pair.getLeft();
        SPEC = pair.getRight();
    }

    private XPSyncConfig(ModConfigSpec.Builder builder) {
        builder.comment(

...
public class ShopsConfig {
    ...
    // Chest Shop settings
    public final ForgeConfigSpec.BooleanValue chestShopsEnabled;
    public final ForgeConfigSpec.IntValue chestShopsMaxPerPlayer;
    public final ForgeConfigSpec.DoubleValue chestShopsTaxRate;
    public final ForgeConfigSpec.BooleanValue chestShopsAdminOnlyCreate;
    public final ForgeConfigSpec.BooleanValue chestShopsAllowBuyType;
    public final ForgeConfigSpec.BooleanValue chestShopsAllowSellType;
    public final ForgeConfigSpec.BooleanValue chestShopsDisplayItems;
    public final ForgeConfigSpec.BooleanValue chestShopsProtectChests;
    public final ForgeConfigSpec.BooleanValue chestShopsRequireChestAccess;
    public final ForgeConfigSpec.DoubleValue chestShopsMinPrice;
    public final ForgeConfigSpec.DoubleValue chestShopsMaxPrice;
    public final ForgeConfigSpec.BooleanValue chestShopsAllowFreeShops;
    public final ForgeConfigSpec.IntValue chestShopsFindDistance;
    public final ForgeConfigSpec.BooleanValue chestShopsShowOutOfStock;

    // Sign Shop settings
    public final ForgeConfigSpec.BooleanValue signShopsEnabled;
    public final ForgeConfigSpec.IntValue signShopsMaxPerPlayer;
    public final ForgeConfigSpec.BooleanValue signShopsRequirePermission;
    public final ForgeConfigSpec.DoubleValue signShopsTaxRate;

    // GUI Shop settings (Server Admin Shop)
    public final ForgeConfigSpec.BooleanValue guiShopEnabled;
    public final ForgeConfigSpec.ConfigValue<String> guiShopMenuTitle;
    public final ForgeConfigSpec.BooleanValue guiShopSellAllEnabled;
    public final ForgeConfigSpec.DoubleValue guiShopSellAllTaxRate;

    // Player Market settings
    public final ForgeConfigSpec.BooleanValue playerMarketEnabled;
    public final ForgeConfigSpec.IntValue playerMarketMaxListings;
    public final ForgeConfigSpec.IntValue playerMarketListingDurationHours;
    public final ForgeConfigSpec.DoubleValue playerMarketTaxRate;
    public final ForgeConfigSpec.DoubleValue playerMarketMinPrice;
    public final ForgeConfigSpec.DoubleValue playerMarketMaxPrice;
    public final ForgeConfigSpec.BooleanValue playerMarketNotifyOnSale;

    // Transaction logging
    public final ForgeConfigSpec.BooleanValue transactionLogEnabled;
    public final ForgeConfigSpec.IntValue transactionLogRetentionDays;

    static {
        Pair<ShopsConfig, ForgeConfigSpec> pair = new ForgeConfigSpec.Builder()
                .configure(ShopsConfig::new);
        CONFIG = pair.getLeft();
        SPEC = pair.getRight();
    }

    private ShopsConfig(ForgeConfigSpec.Builder builder) {
        builder.comment(

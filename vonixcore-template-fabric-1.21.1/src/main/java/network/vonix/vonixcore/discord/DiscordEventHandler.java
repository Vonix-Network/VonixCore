...
public class DiscordEventHandler {
    ...
    /**
     * Called when a player earns an advancement. Call this from wherever
     * advancements are handled.
     */
    public static void onAdvancement(ServerPlayer player, Advancement advancement) {
        ...
        // In 1.21+, display() returns an Optional
        java.util.Optional<DisplayInfo> displayOpt = advancement.display();
                        ...
                        .then(Commands.literal("discord")
                                .then(Commands.literal("link")
                                        .executes(context -> {
                                            ...
                                            if (code != null) {
                                                int expiryMinutes = DiscordConfig.getInstance().getLinkCodeExpiry()
                                                        / 60;

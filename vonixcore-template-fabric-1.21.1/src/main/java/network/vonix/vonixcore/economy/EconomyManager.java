...
public class EconomyManager {
    ...
    public void unloadPlayerBalance(UUID uuid) {
        // We might want to keep it for a bit or save explicitly
        // Since we save on every modification, we can just remove.
        // But to be safe, let's save one last time if we track dirty state.
        // Here we assume write-through (async) so cache is always "clean-ish".

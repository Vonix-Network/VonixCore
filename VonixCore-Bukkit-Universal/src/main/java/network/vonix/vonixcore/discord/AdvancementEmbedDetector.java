...
public class AdvancementEmbedDetector {
    ...
    public boolean isAdvancementEmbed(Embed embed) {
        ...
        try {
            ...
            VonixCore.getInstance().getLogger().log(Level.WARNING, 
                "[Discord] Error during advancement embed detection: " + e.getMessage());
            return false;
        }
    }
    ...
    public AdvancementType getAdvancementType(Embed embed) {
        ...
        try {
            ...
            VonixCore.getInstance().getLogger().log(Level.WARNING, 
                "[Discord] Error determining advancement type: " + e.getMessage());
        }
